package com.aaron.aarontools.views;
...
public class MyActionBar extends RelativeLayout {
    ...
    private void init (Context context, TypedArray ta) {
        ...
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate (R.layout.my_action_bar_relativelayout, null);
    ...
    private void setAttrs (Context context, TypedArray ta) {
        ...
        if (titleSize != 0) {
            mTitleTextView.setTextSize (UtilTools.getFontSize (context, titleSize / 2.3f));// 2.3f 是根据测试计算出来的
        }
        ...
        if (leftSize != 0) {
            mLeftTextView.setTextSize (UtilTools.getFontSize (context, leftSize / 2.3f));
        }
        ...
        if (rightSize != 0) {
            mRightTextView.setTextSize (UtilTools.getFontSize (context, rightSize / 2.3f));
        }
